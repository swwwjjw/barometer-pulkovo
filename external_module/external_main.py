...
KEYWORDS = [
    ...
    'Машинист катка',
    'Инженер склада',
    'Фельдшер / фельдшер скорой медицинской помощи',
    'Специалист по обслуживанию ВС',
    'Мойщик-уборщик',
    'Медицинская сестра/медицинский брат',
    'Системный инженер',
    'Инспектор Перронного Контроля',
    'Кинолог',
    'Инженер холодильных установок',
    'Инспектор Группы Быстрого Реагирования'
]
