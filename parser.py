...
# pulkovo_salary - fixed salary for Pulkovo comparison (if set, overrides calculated value)
ROLES_CONFIG = [
    {"name": "Грузчик (терминал)", "ids": [31, 52], "pulkovo_salary": 113640},
    {"name": "Грузчик (перрон)", "ids": [31, 52], "pulkovo_salary": 128740},
