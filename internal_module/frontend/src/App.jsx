...
const ROLE_DISPLAY_NAMES = {
  ...
  'уборщик самолетов': 'Мойщик-уборщик',
  ...
  'товаровед кладовщик': 'Товаровед магазина',
  'тракторист снег': 'Тракторист',
  'регистрация пассажиров': 'Агент по регистрации пассажиров (ПО)',
  'обслуживание в бизнес-залах': 'Агент по сервису в бизнес-зал',
  'официант сервировка': 'Агент по сервису',
  'машинист фреза': 'Машинист фрезы',
  'aналитик 1С: ERP': 'Аналитик 1C:ERP',
  'программист 1С ЗУП': 'Ведущий разработчик 1С'
};
...
const TEAM_PROJECT_SALARY = {
  ...
  'фельдшер помощь': 0,
  'обслуживание воздушных судов': 30680,
  'уборщик самолетов': 0,
  ...
  'закупки булочная': 0,
  'управляющий кафе': 0,
  'товаровед кладовщик': 0,
  'тракторист снег': 0,
  'регистрация пассажиров': 0,
  'обслуживание в бизнес-залах': 0,
  'официант сервировка': 0,
  'машинист фреза': 0,
  'aналитик 1С: ERP': 0,
  'программист 1С ЗУП': 0
};
