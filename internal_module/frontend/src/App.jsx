      ...
      {!loading && stats && stats.metrics && stats.comparison && (
        <div className="market-card">
          ...
          <div className="market-ticks">
            ...
            <div className="val-p50">{Math.round(stats.metrics.min + (stats.metric.max - stats.metrics.min) * 0.25).toLocaleString()} ₽</div>
            <div className="val-p75">{Math.round(stats.metrics.min + (stats.metrics.max - stats.metrics.min) * 0.5).toLocaleString()} ₽</div>
