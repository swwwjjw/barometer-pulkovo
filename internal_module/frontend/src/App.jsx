...
const ROLE_DISPLAY_NAMES = {
  ...
  'руководитель склада инженер': 'Инженер склада',
  'фельдшер помощь': 'Фельдшер / фельдшер скорой медицинской помощи',
  'обслуживание воздушных судов самолетов': 'Специалист по обслуживанию ВС',
...
const TEAM_PROJECT_SALARY = {
  ...
  'ml engineer': 0,
  'машинист катка': 0,
  'руководитель склада инженер': 0,
  'фельдшер помощь': 0,
  'обслуживание воздушных судов самолётов': 32000,
  'мойщик посуды': 24000,
  'осмотр медицинской': 0,
  'системный виртуализация': 0,
  'склад комплектовщик': 32000,
  'кинолог': 0,
  'инженер холодильного': 24000,
  'гбр охрана': 0
};
